...
Public Class Form2
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If TextBox1.Text = "Raihana" And TextBox2.Text = "2964" Then
            MessageBox.Show("Admin login successful")
            Dim adpg As New adminpage
            adminpage.Show()
        Else
            MessageBox.Show("Recheck ")
        End If
        Me.Close()
    End Sub
End Class
'User Login'
Public Class Form3
    Private Const CorrectUsername As String = "sara"
    Private Const CorrectPassword As String = "123"
    ...
    Private Function ValidateCredentials(enteredUsername As String, enteredPassword As String) As Boolean
        Return enteredUsername = CorrectUsername AndAlso enteredPassword = CorrectPassword
    End Function
End Class
'User Dashboard'
Public Class Form4
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Me.Close()
        Dim feedbackpg As New feedback
        feedbackpg.Show()
    End Sub
...
Public Class adminpage
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Me.Close()
        Dim modstudata As New modifydatabase
        modstudata.Show()
    End Sub

    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Me.Close()
        Dim viewf As New viewdatabase
        viewf.Show()
    End Sub

    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Me.Close()
        Dim viewreg As New viewregform
        viewreg.Show()
    End Sub
